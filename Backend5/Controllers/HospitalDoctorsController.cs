...
namespace Backend5.Controllers
{
    public class HospitalDoctorsController : Controller
    {
        ...
        public async Task<IActionResult> Create(Int32? hospitalId, HospitalDoctorCreateModel model)
        {
            ...
            if (HospitalDoctorExists(hospital.Id, model.DoctorId))
            {
                this.ModelState.AddModelError("DoctorId", "This doctor is already attached to this hospital");
                this.ViewBag.Hospital = hospital;
        ...
        private bool HospitalDoctorExists(Int32 hospitalId, Int32 doctorId)
        {
            return context.HospitalDoctors.Any(e => e.HospitalId == hospitalId && e.DoctorId == doctorId);
        }
    }
}
