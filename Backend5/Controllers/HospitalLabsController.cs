...
namespace Backend5.Controllers
{
    public class HospitalLabsController : Controller
    {
        ...
        public async Task<IActionResult> Create(Int32? hospitalId, HospitalLabCreateModel model)
        {
            ...
            if (HospitalLabExists(hospital.Id, model.LabId))
            {
                this.ModelState.AddModelError("LabId", "This labarotria is already attached to this hospital");
                this.ViewBag.Hospital = hospital;
        ...
        private bool HospitalLabExists(Int32 hospitalId, Int32 labId)
        {
            return context.HospitalLabs.Any(e => e.HospitalId == hospitalId && e.LabId == labId);
        } 
    }
}
